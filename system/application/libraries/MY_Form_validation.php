...
* This library handles extending the CI core form_validation class.
* This library is a modifed version of the FAL_validation library. 
* It includes new methods previously not in the older version.
*  Below is the original notices by the authors of FreakAuth_light.
============================================================================
...
class MY_Form_validation extends CI_Form_validation
{
  ...
  /**
     * Not used with new captcha system from recaptcha.net (30 Dec 2009)
     * RULES HELPER FUNCTION
	...
	/**
	 * Validate the user's input and captcha challenge word via the API provided by recaptcha.net
	 *
	 * @param string $val
	 * @return boolean
	 */
	...
	function captcha_check($val) {
	  if ($this->CI->recaptcha->check_answer($this->CI->input->ip_address(),$this->CI->input->post('recaptcha_challenge_field'),$val)) {
	    ...
	    $this->set_message('captcha_check',$this->CI->lang->line('recaptcha_incorrect_response'));
	    return FALSE;
	  }
	}
}
