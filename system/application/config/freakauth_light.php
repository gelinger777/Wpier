...
/**
* Removed configuration keys that are no longer needed in this modified version of
* FreakAuth_light
...
+---------------------*/
 ...
 |
 */
 $config['FAL_website_name']    = $_SERVER['SERVER_NAME'];
 ...
 |
 */
 $config['FAL_user_support'] = 'maridansoft@yahoo.com';
 ...
 */
 ...
 |------------------------------------------------------------------------------
 */
 $config['FAL_register_direct'] = TRUE;
 ...
 */
 ...
 // CAPTCHA VIEW
  $config['FAL_recaptcha_view'] = $config['FAL_template_dir'].'content/forms/recaptcha';
...
$config['FAL_admin_console_records_per_page'] = 2;
...
$config['FAL_user_profile_fields_names'] =
    array('field_1' => 'name',
          'field_2' => 'surname',
          'call_me_nicely' => 'FreaKauth&copy; rocks',
         //'4'=>'whatyouwant',
         //'5'=>'whatyouwant',
    );
