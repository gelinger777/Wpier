...
*/
	...
	* and/or last one of the recordset. Added by Ivбn Oliva to provide recordset pagination.
	*
   ...
   /**
	...
	var $_currentPage = -1;	/** Added by Ivбn Oliva to implement recordset pagination */
	var $_atFirstPage = false;	/** Added by Ivбn Oliva to implement recordset pagination */
	var $_atLastPage = false;	/** Added by Ivбn Oliva to implement recordset pagination */
	var $_lastPageNo = -1; 
