...
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/Spreadsheet/Excel/Writer/Format.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/Spreadsheet/Excel/Writer/BIFFwriter.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/Spreadsheet/Excel/Writer/Worksheet.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/Spreadsheet/Excel/Writer/Parser.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/OLE/PPS/Root.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/OLE/PPS/File.php';
