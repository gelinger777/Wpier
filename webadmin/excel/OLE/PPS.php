...
// +----------------------------------------------------------------------+
//
// $Id: PPS.php,v 1.1 2003/05/12 23:38:01 xnoguer Exp $


require_once($_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/PEAR.php');
require_once($_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/excel/OLE.php');
