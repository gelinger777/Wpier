...
FCKConfig.EditorAreaCSS = '/style/text.css' ;
...
FCKConfig.Plugins.Add( 'insertimg' ) ;
FCKConfig.Plugins.Add( 'insertbr' ) ;
FCKConfig.Plugins.Add( 'modifyhtml' ) ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','PasteWord','modifyhtml','-','Print','SpellCheck'],
	...
	['Link','Unlink','Anchor'],
	['insertimg','insertbr','Flash','Table','Rule','SpecialChar'],
	['TextColor','BGColor'],
	['ShowBlocks','-','About']	,
	'/',
...
FCKConfig.StylesXmlPath		=  '/style/styles.xml' ;
