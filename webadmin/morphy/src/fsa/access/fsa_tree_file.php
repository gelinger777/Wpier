...
class phpMorphy_Fsa_Tree_File extends phpMorphy_Fsa {
	function walk($trans, $word, $readAnnot = true) {
		$fh = $this->resource; $fsa_start = $this->fsa_start;
	...
	protected function readAlphabet() {
		...
		fseek($fh, $this->header['alphabet_offset']); 
		return fread($fh, $this->header['alphabet_size']);
	}
