Ext.ux.grid.filter.DateFilter = Ext.extend(Ext.ux.grid.filter.Filter, {
	...
	init: function(){
		...
		var dates = this.dates = {
			'after':  new Ext.menu.CheckItem({text: ParentW.DLG.t('FltrDateAfter'), menu: new Ext.menu.DateMenu(opts)}),
			'before': new Ext.menu.CheckItem({text: ParentW.DLG.t('FltrDateBefore'), menu: new Ext.menu.DateMenu(opts)}),
			'on':     new Ext.menu.CheckItem({text: ParentW.DLG.t('FltrDateOn'), menu: new Ext.menu.DateMenu(opts)})};
