...
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/pear/PEAR.php';
require_once $_SERVER["DOCUMENT_ROOT"].'/'.$_CONFIG["ADMINDIR"].'/pear/spreadsheet/excel/writer/Workbook.php';
